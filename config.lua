...
Config.Garages = {
    ...
    ['impoundlot'] = {
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-355.8200, -103.4264, 45.6667, 343.5441),
            vector4(-352.4240, -104.6562, 45.6667, 340.9680),
            vector4(-359.1899, -102.4665, 45.6667, 340.6846),
            vector4(-362.5256, -101.4726, 45.6667, 339.2061),
            vector4(-366.0104, -100.0755, 45.6667, 342.7883),
            vector4(-369.1876, -98.8011, 45.6647, 344.4265),
            vector4(-372.6360, -97.7341, 45.6647, 342.2298),
        }
    },
    ['sandyimpoundlot'] = {
        ['Zone'] = {
