...
Config.ShowNearestParkingOnly = true
...
Config.Garages = {
    ...
    ['impoundlot'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-339.08615112305, -85.994789123535),
                vector2(-347.80743408203, -109.62271881104),
                vector2(-375.29678344727, -99.653709411621),
                vector2(-372.12228393555, -90.327751159668),
                vector2(-379.14920043945, -87.942565917969),
                vector2(-373.16204833984, -73.882354736328)
            },
            ['minZ'] = 45.66,  -- min height of the parking zone
            ['maxZ'] = 45.73,  -- max height of the parking zone
            debug = false,
        },
        label = "Depot",
        showBlip = true,
        blipcoords = vector3(-361.5256, -99.4452, 45.6667),
        blipName = "SADOT Depot",
        blipNumber = 68,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-184.04, -1174.13, 23.04, 199.5),
            vector4(-187.59, -1174.01, 23.04, 201.94),
            vector4(-191.15, -1173.96, 23.04, 197.52),
            vector4(-194.65, -1173.81, 23.04, 201.85),
            vector4(-198.14, -1173.76, 23.04, 206.89),
            vector4(-177.81, -1165.98, 23.04, 176.76),
            vector4(-173.3, -1165.97, 23.04, 177.82),
            vector4(-205.65, -1168.2, 23.04, 180.02),
            vector4(-209.02, -1168.12, 23.04, 178.87),
            vector4(-212.72, -1168.05, 23.04, 178.24),
        }
    },
    ['sandyimpoundlot'] = {
        ['Zone'] = {
    ...
    ['police'] = {
        ...
        blipName = "Police",
        blipNumber = 357,
        blipcoords = vector3(449.57, -1024.85, 28.06),
    ...
    --     blipName = "Police",
    --     blipNumber = 357,
    --     blipcoords = vector(581.11, 38.73, 92.21),
    --     type = 'job',                --public, job, gang, depot
    --     vehicleCategories = {'emergency'},
    --     drawText = 'Parking',              --car, air, sea
    --     job = "police",
    ...
    ['apartments'] = {
        ...
        blipName = "Public Parking",
        blipNumber = 357,
        blipcoords = vector3(-297.72, -990.1, 31.08),
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
    ...
    ['cityhall'] = {
        ...
        blipName = "Public Parking",
        blipNumber = 357,
        blipcoords = vector3(-475.26, -219.26, 36.05),
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
    ...
    ['pdfront'] = {
        ...
        blipNumber = 357,
        blipcoords = vector3(407.44, -997.7, 28.94),
        type = 'job',
        job = "police",
        vehicleCategories = {'emergency'},
        drawText = 'Parking',
    ...
    ['pdgarage'] = {
        ...
        blipName = "Police Parking",
        blipNumber = 357,
        blipcoords = vector3(445.67, -997.0, 24.81),
        type = 'job',
        job = "police",
